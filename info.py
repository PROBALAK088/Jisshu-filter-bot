...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002348601098'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/movierequest88')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002456017788').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002348601098'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002380093107')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002348601098'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002178835257')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002219563250'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002320054503') # If anyone sends a request message to your bot, you will get it in this channel.
